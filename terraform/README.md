...
| `model_uuid`  | string   | Reference to an existing model resource or data source for the model to deploy |             |
...
To deploy this module with its needed dependency, you can run `terraform apply -var="model_uuid=<MODEL_UUID>"`
